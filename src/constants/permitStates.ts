...
export const VARIANT_DEFINITIONS = {
  happy_path: {
    sequence: ['submitted', 'intake_validation', 'assigned_to_reviewer', 'review_in_progress', 'final_review', 'approved'] as PermitState[],
    probability: 0.6,
    name: 'Happy Path'
  },
  info_loop: {
    sequence: ['submitted', 'intake_validation', 'assigned_to_reviewer', 'review_in_progress', 'request_additional_info', 'applicant_provided_info', 'review_in_progress', 'final_review', 'approved'] as PermitState[],
    probability: 0.25,
    name: 'Info Loop'
  },
  rejected: {
    sequence: ['submitted', 'intake_validation', 'assigned_to_reviewer', 'review_in_progress', 'final_review', 'rejected'] as PermitState[],
    probability: 0.1,
...
export const TRANSITION_TIME_RANGES = {
  ...
  'review_in_progress->final_review': { min: 24, max: 168 }, // 1-7 days
  ...
  'final_review->approved': { min: 24, max: 120 }, // 1-5 days
  'final_review->rejected': { min: 24, max: 120 },
